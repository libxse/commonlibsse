...
namespace RE
{
	...
	namespace BSGraphics
	{
		...
		struct RendererData
		{
			...
			DepthStencilData                   depthStencils[RENDER_TARGET_DEPTHSTENCIL::kTOTAL];    // 2008
			CubemapRenderTargetData            cubemapRenderTargets[RENDER_TARGET_CUBEMAP::kTOTAL];  // 2728
			Texture3DTargetData                texture3DRenderTargets[RENDER_TARGET_3D::kTOTAL];     // 2768
			float                              clearColor[4];                                        // 27C8
			std::uint8_t                       clearStencil;                                         // 27D8
			REX::W32::CRITICAL_SECTION         lock;                                                 // 27E0
			const char*                        className;                                            // 2808
			REX::W32::HINSTANCE                hInstance;                                            // 2810
		};
